...
import in.gowtham.serviceInterface.RegisterService;
	...
	//	The RegisterEntity object is not shared between users; it's specific to this request.
		...
		if (exist == false) {
			...
			if (uid > 0) {
				...
				model.addAttribute("message", "Register UnSuccessfull");
				page = "Signup";
			}
		} else {
...
//this will get the current name and the passoword of the user who has entered
	...
	// admin
	//the method is from the delete method if something gets deleted
